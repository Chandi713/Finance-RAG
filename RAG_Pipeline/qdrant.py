...
# Usage Example
# def main():
#     """Example usage of the FinancialRAGSystem"""
    
#     # Initialize QdrantPipeline
#     qdrant_pipeline = QdrantPipeline(
#         qdrant_url="https://4ac688c0-8734-4b81-95c1-ce75a9885616.us-east4-0.gcp.cloud.qdrant.io:6333", 
#         api_key="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2Nlc3MiOiJtIn0.bsNiaVU6Ld6LqgaChjfxJDCwzSIkyqDojsDXDqOm9vA"
#     )
    
#     qdrant_pipeline.create_indexes_manually()

#     # Initialize RAG system
#     rag_system = FinancialRAGSystem(
#         qdrant_pipeline=qdrant_pipeline,
#         gemini_api_key="AIzaSyCxp2ASbllZYJstdfKrd-y_zQIrpzxPeTY"
#     )

#     # Example queries
#     queries = [
#         # "What was Microsoft's total Revenue for the fiscal year 2022? Also, check for Apple too.",
#         # "Calculate the percentage change in Net income from fiscal year 2020 to fiscal year 2023.",
...
#             print(f"Current Metadata: {result['current_metadata']}")
